...
class AlbumAdapter() : RecyclerView.Adapter<AlbumAdapter.MyViewHolder>() {
    ...
    lateinit var mListener: VideoClickCallback

    constructor(albumList: ArrayList<GalleryAlbums> = ArrayList(), currentFragment: Fragment, listener: VideoClickCallback) : this() {
        ...
        holder.albumFrame.setOnClickListener {
            when (currentFragment) {
                ...
                is VideosFragment -> {
                    ...
                    (currentFragment as VideosFragment).imageGrid.adapter = VideoGridAdapter((currentFragment as VideosFragment).photoList, malbumList[holder.adapterPosition].id, listener = mListener)
