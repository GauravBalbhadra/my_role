...
public class Functions {
   ...
   public static ProgressBar determinant_progress;
    ...
    public static void Show_determinent_loader(Context context, boolean outside_touch, boolean cancleable, DownloadDialogListener downloadDialogListener) {
        ...
        determinant_dialog.findViewById(R.id.close).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
              //  Toast.makeText(context, "video is still downloading in background.", Toast.LENGTH_SHORT).show();
                downloadDialogListener.onDismissDialog();
                determinant_dialog.dismiss();//findViewById(R.id.parentView).setVisibility(View.GONE);
            }
        });
    }
