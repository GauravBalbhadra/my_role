...
public class SongEncodeRunnable implements Runnable {
    private static final String TAG = "SongEncodeRunnable";
    private String audioPath;
    private SongDecodeListener mListener;
    private String pcmPath;

    public SongEncodeRunnable(String str, String str2, SongDecodeListener songDecodeListener) {
        this.pcmPath = str;
        this.audioPath = str2;
        this.mListener = songDecodeListener;
    }
    ...
    public void run() {
        ...
        try {
            if (new File(this.pcmPath).exists()) {
                ...
                while (!z2) {
                    ...
                    for (int dequeueOutputBuffer = createEncoderByType.dequeueOutputBuffer(bufferInfo, 10000); dequeueOutputBuffer >= 0; dequeueOutputBuffer = createEncoderByType.dequeueOutputBuffer(bufferInfo, 10000)) {
                        ...
                        SongCodec.addADTStoPacket(bArr2, i3);
            ...
            e.printStackTrace();
            SongDecodeListener audioDecodeListener = this.mListener;
