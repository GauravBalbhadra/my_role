package com.myrole.camera_ck.internal.manager.impl;
...
import com.myrole.camera_ck.internal.utils.ImageSaver;
...
public final class Camera2Manager extends BaseCameraManager<String, TextureView.SurfaceTextureListener>
    ...
    protected void prepareCameraOutputs() {
        try {
            ...
            photoSize = CameraHelper.getMaxSizeRatio(Size.fromArray2(map.getOutputSizes(ImageFormat.JPEG)));
