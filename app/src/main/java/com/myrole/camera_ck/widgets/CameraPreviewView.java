...
public class CameraPreviewView extends RelativeLayout {
    ...
    protected RecorderParamsI mParams;
    ...
    @Nullable
    public RecorderParamsI getParams() {
        return mParams;
    }

    public void setParams(@Nullable RecorderParamsI params) {
        mParams = params;
    }
    ...
    protected boolean calculateSize() {
        ...
        if (mPreviewSize == null) {
            ...
            if (!CameraUtil.isContextConfigurationLandscape(getContext())) {
