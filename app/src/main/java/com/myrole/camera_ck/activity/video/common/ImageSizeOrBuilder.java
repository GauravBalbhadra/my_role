package com.myrole.camera_ck.activity.video.common;
...
public abstract class ImageSizeOrBuilder {
    ...
    public Optional<Integer> getWidth() {
        int width = width();
        return width == UNDEFINED ? Optional.absent() : Optional.of(width);
    }
    ...
    public Optional<Integer> getHeight() {
        int height = height();
        return height == UNDEFINED ? Optional.absent() : Optional.of(height);
    }
