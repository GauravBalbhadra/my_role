package com.myrole.camera_ck.activity.preview;
...
import com.myrole.camera_ck.internal.utils.ImageLoader;
...
public class PreviewActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private AppCompatTextView cropMediaAction;
    private AppCompatTextView ratioChanger;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        AppCompatTextView confirmMediaResult = (AppCompatTextView) findViewById(R.id.confirm_media_result);
        AppCompatTextView reTakeMedia = (AppCompatTextView) findViewById(R.id.re_take_media);
        AppCompatTextView cancelMediaAction = (AppCompatTextView) findViewById(R.id.cancel_media_action);
        cropMediaAction = (AppCompatTextView) findViewById(R.id.crop_image);
        ratioChanger = (AppCompatTextView) findViewById(R.id.ratio_image);
