...
public final class CropImage {
    ...
    public static final int CROP_IMAGE_FRAGMENT_REQUEST_CODE = 12;
    ...
    public static final class ActivityBuilder {
        ...
        public void start2(@NonNull Activity activity) {
            mOptions.validate();
            activity.startActivityForResult(getIntent(activity), CROP_IMAGE_FRAGMENT_REQUEST_CODE);
        }
        /**
         * Start {@link CropImageActivity}.
         *
         ...
         * <i>Default: false</i>
         */
        public ActivityBuilder setDeleteImage(boolean deleteImage) {
            mOptions.deleteImage = deleteImage;
            return this;
        }
