...
public class PostListDTO implements Serializable {
    ...
    private ArrayList<PostListDTO> data;
    private ArrayList<PostListDTO> paging;
    ...
    private boolean visible_or_not;
    ...
    public boolean isVisible_or_not() {
        return visible_or_not;
    }

    public void setVisible_or_not(boolean visible_or_not) {
        this.visible_or_not = visible_or_not;
    }
    ...
    public ArrayList<PostListDTO> getPaging() {
        return paging;
    }

    public void setPaging(ArrayList<PostListDTO> paging) {
        this.paging = paging;
    }
    ...
    public ArrayList<PostListDTO> getData() {
        return data;
    }

    public void setData(ArrayList<PostListDTO> data) {
        this.data = data;
    }
