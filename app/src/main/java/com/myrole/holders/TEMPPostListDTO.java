...
public class TEMPPostListDTO {
    ...
    private ArrayList<TEMPPostListDTO> paging;
    ...
    public ArrayList<TEMPPostListDTO> getPaging() {
        return paging;
    }

    public void setPaging(ArrayList<TEMPPostListDTO> paging) {
        this.paging = paging;
    }
