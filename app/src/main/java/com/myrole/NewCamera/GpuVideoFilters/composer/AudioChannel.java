package com.myrole.NewCamera.GpuVideoFilters.composer;
...
class AudioChannel {
    ...
    void setActualDecodedFormat(final MediaFormat decodedFormat) {
        ...
        if (inputSampleRate != encodeFormat.getInteger(MediaFormat.KEY_SAMPLE_RATE)) {
            throw new UnsupportedOperationException("StorageAudioFile sample rate conversion not supported yet.");
        }
