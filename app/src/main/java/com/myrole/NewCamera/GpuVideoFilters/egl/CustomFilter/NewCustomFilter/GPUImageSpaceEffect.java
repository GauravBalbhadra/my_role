...
public class GPUImageSpaceEffect extends GlFilter {

    private static final String SPCEEFFECT_FRAGMENT_SHADER =
            "#ifdef GL_ES\n" +
                    ...
                    "gl_FragColor = fragCol + texture2D(sTexture, vTextureCoord);\n" +
                    "}\n";
    final long START_TIME = System.currentTimeMillis();
    int heights;
    int widths;

    public GPUImageSpaceEffect() {
        super(DEFAULT_VERTEX_SHADER, SPCEEFFECT_FRAGMENT_SHADER);
