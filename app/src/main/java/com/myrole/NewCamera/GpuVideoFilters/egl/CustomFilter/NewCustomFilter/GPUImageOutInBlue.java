...
public class GPUImageOutInBlue extends GlFilter {

    private static final String OUTINBLUE_FRAGMENT_SHADER =
            "#ifdef GL_ES\n" +
                    ...
                    "gl_FragColor = vec4(backCol2, 1.0) + texture2D(sTexture, vTextureCoord);\n" +
                    "}";
    final long START_TIME = System.currentTimeMillis();
    int heights;
    int widths;

    public GPUImageOutInBlue() {
        super(DEFAULT_VERTEX_SHADER, OUTINBLUE_FRAGMENT_SHADER);
