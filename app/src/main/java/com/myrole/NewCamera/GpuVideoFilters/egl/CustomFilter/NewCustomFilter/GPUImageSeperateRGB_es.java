...
public class GPUImageSeperateRGB_es extends GlFilter {
    private static final String SEPRATEDRGB_FRAGMENT_SHADER =
            "#ifdef GL_ES\n" +
    ...
    public GPUImageSeperateRGB_es() {
        super(DEFAULT_VERTEX_SHADER, SEPRATEDRGB_FRAGMENT_SHADER);
    ...
    public void onDraw() {
        ...
        GLES20.glUniform1f(getHandle("strength"), 0.2f);
    }
