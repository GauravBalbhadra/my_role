...
public class SearchContactsAdapter1 extends RecyclerView.Adapter<SearchContactsAdapter1.ContactHolder> {
    List<Contact> contacts;
    Context context;

    public SearchContactsAdapter1(List<Contact> contacts, Context context) {
