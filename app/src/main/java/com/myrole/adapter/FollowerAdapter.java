...
public class FollowerAdapter extends RecyclerView.Adapter<FollowerAdapter.ContactHolder> implements Filterable {
    ...
    public FollowerAdapter(List<Contact> contacts, Context context, Activity activity) {
...
//        holder.btnInvite.setVisibility(View.GONE);
        if (contact.follow.equals(userId)) {
