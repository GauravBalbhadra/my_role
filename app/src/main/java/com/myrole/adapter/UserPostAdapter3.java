...
//import com.myrole.fragments.NewUserCategoryPostFragment;
...
//
//public class UserPostAdapter3 extends RecyclerView.Adapter<UserPostAdapter3.viewHolder> implements View.OnClickListener {
//    List<Post> postList;
//    Context context;
//    NewUserCategoryPostFragment fm;
//    AppPreferences preferences;
//
//    public UserPostAdapter3(List<Post> postList, Context context, NewUserCategoryPostFragment fm) {
...
//        }
//
//        if (postList != null && postList.get(position).owner_image.length() > 0) {
//            Picasso.with(context).load(postList.get(position).owner_image).into(holder.usericon);
//        } else {
...
//        postList.remove(Pos);
//        fm.recyclerView.setAdapter(new UserPostAdapter3(postList, context, fm));
//        notifyDataSetChanged();
//
//    }
//
