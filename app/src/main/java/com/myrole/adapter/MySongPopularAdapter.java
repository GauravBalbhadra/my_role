...
public class MySongPopularAdapter extends RecyclerView.Adapter<MySongPopularAdapter.MixupViewHolder> {

    private final List<Song> mSongList;
    private SongClickCallback mSongClickCallback;

    public MySongPopularAdapter(SongClickCallback songClickCallback, List<Song> songItemList, SharedViewModel model) {
    ...
    @NotNull
    @Override
    public MySongPopularAdapter.MixupViewHolder onCreateViewHolder(@NotNull ViewGroup parent, int viewType) {
        ...
        return new MySongPopularAdapter.MixupViewHolder(binding);
    }

    @Override
    public void onBindViewHolder(final MySongPopularAdapter.MixupViewHolder holder, final int position) {
